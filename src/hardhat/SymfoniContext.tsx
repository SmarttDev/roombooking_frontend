...
import { RoomBooking } from "./typechain/RoomBooking";
import { RoomBooking__factory } from "./typechain/factories/RoomBooking__factory";
...
export const RoomBookingContext = React.createContext<SymfoniRoomBooking>(emptyContract);
...
export interface SymfoniRoomBooking {
    instance?: RoomBooking;
    factory?: RoomBooking__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const [RoomBooking, setRoomBooking] = useState<SymfoniRoomBooking>(emptyContract);
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                setRoomBooking(getRoomBooking(_provider, _signer))
                finish(text)
            }
    ...
    const getRoomBooking = (_provider: providers.Provider, _signer?: Signer) => {
        ...
        const contractAddress = "0x2Ccb435Fab99EAF41c2DF6628851bcc64a3eA508"
        ...
        const contract: SymfoniRoomBooking = {
            instance: instance,
            factory: _signer ? new RoomBooking__factory(_signer) : undefined,
        }
        return contract
    }
        ;
            ...
            <ProviderContext.Provider value={[provider, setProvider]}>
                <SignerContext.Provider value={[signer, setSigner]}>
                    <CurrentAddressContext.Provider value={[currentAddress, setCurrentAddress]}>
                        <RoomBookingContext.Provider value={RoomBooking}>
                            {showLoading && loading ?
